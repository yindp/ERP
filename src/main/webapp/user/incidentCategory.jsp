...
<div>
    <table class="easyui-datagrid" title="Incident Category" style="height:250px"
        ...
        <s:iterator value="incidentCategoryList">
            <tr>
...
<div>
    <div id="w" class="easyui-window" title="Add a post" data-options="modal:true,closed:true"
        ...
        <s:form action="/admin/incidentCategory/add" method="POST">

            <s:select label="Parent" list="#incidentCategoryList" listKey="id" listValue="name" headerKey="-1" headerValue="Null"
                      name="incidentCategory.parentCategory.id"/>
            <s:textfield label="Name" name="incidentCategory.name"/>
